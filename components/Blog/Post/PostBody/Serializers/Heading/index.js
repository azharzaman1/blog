...
const Heading = ({
  ...
  const styles = {
    ...
    h2: "mt-10 text-text font-semibold text-4xl text-gray-900 tracking-tight leading-normal",
    h3: "mt-8 text-text font-semibold text-3xl text-gray-900 tracking-normal leading-normal",
    h4: "mt-6 text-text font-semibold text-2xl text-gray-900 tracking-normal leading-normal",
